<?php
		...
		$_SESSION['recipe_id_edit'] = $_GET['id'];
...
<?php 
		...
		$user_id_recipe_check = $row['user_id'];
		
	if($user_id_check == $user_id_recipe_check){
		header("refresh:0.1;url=details_a.php?id={$row['id']}");
			...
			<center>
				<table>
					<form method="post" action="edit_recipe.php">
						<tr>
							<td>
								<input placeholder= "<?php echo $row['recipe_name'];?>"  name="recipe_name_edit" id="recipe_name_edit" type="text"  required> 
							</td>
						</tr>
						<tr>
						...
						<tr>
							<td>
								<textarea placeholder= "<?php echo $row2['ingredients'];?>" name="recipe_ingredients_edit" id="recipe_ingredients_edit" style="width:500px;height:100px;" required></textarea>

							</td>
						</tr>
						<tr>
							<td>
								<textarea placeholder= "<?php echo $row2['description'];?>" name="recipe_description" id="recipe_description_edit" style="width:500px;height:200px;" required></textarea>
							</td>
						</tr>
						<tr>
							<td>
								<input placeholder= "<?php echo $row2['time'];?>" name="recipe_duration" id="recipe_duration_edit" type="text" required>
