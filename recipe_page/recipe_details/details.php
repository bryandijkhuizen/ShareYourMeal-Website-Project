<?php
		...
		if(isset($_GET['id'])){
				$sql5 = "SELECT avg(rating) as `average` FROM rating JOIN user_login ON user_login.user_id=rating.user_id WHERE recipe_id='$id'";
				...
				<ul>
					...
					<li><a href="../../logout/logout.php">Logout</a></li>
						<div class="user_box">
							...
							<li><center><a href="details_admin.php?id=<?php echo $row['id']; ?>">recipe panel</a></li></ul></ul>
						</div>
		</div>
		...
		<div class="content">
				...
				<?php 
					while($row4 = mysqli_fetch_assoc($result4)){
						echo "<tr><td>" . "<h3>" . $row4['rating'] .  "</td><td>" . $row4['comment'] . "</td><td>" . "<a href='../../user/userpage.php?user_id={$row4['user_id']}'>{$row4['username']}" . "</td>" . "</a>" . "</h3><td></td></tr><br>" ;	
