...
<html lang="en-us"> 
	...
	<body>
		<div class= "navbar">
				<ul>
					<li><a href="index.php"><img src="../img/logo.png" width="50" height="50" alt=""/></a></li>
		...
		<center>
			<div class="body">
				<h1>Welcome to ShareYourMeal.nl</h1>
				<h2>Lots of ingredients? Don't know what to make? Then this is the place to be!</h2>
